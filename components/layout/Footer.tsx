      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <h3 className="font-display text-2xl font-bold mb-4">Carerac</h3>
              ...
              {(['gastronomic', 'cultural', 'space', 'location'] as const).map(link => (
                <li key={link}>
                  <button
                    ...
                    className="text-primary-white/80 hover:text-primary-stone transition-colors font-body"
                  >
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <MapPin size={16} className="text-primary-stone mt-1 flex-shrink-0" />
