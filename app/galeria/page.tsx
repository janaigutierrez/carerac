  ...
  return (
    <div className="min-h-screen bg-primary-white flex flex-col items-center justify-center px-4">
      <div className="text-center max-w-md">
        <h1 className="font-display text-5xl font-bold text-primary-dark mb-4">Galeria</h1>
        <p className="text-primary-gray font-body text-lg mb-8">
          Aviat aqui podras veure imatges de la masia, els espais i les experiencies.
        </p>
        <Link
          href="/"
