...
export const es: Locale = {
  ...
  espai: {
    title: "El Espacio",
    subtitle: "Cada rincon de Can Carerac ha sido restaurado con amor y respeto por la tradicion catalana, creando espacios unicos para experiencias inolvidables.",
    spaces: {
      piscina: { title: "La Piscina", description: "Aguas cristalinas rodeadas de vegetacion mediterranea autoctona" },
      hort: { title: "El Huerto", description: "Ingredientes frescos cultivados con amor para nuestras experiencias" },
      cuina: { title: "La Cocina", description: "Horno de lena centenario y utensilios tradicionales para elaboracion artesanal" },
  ...
  experiencies: {
    ...
    gastronomica: {
      ...
      duration: "Medio dia - 4 horas",
      activities: [
        "Moler grano tradicional para obtener harina",
        "Elaboracion de masa madre ancestral",
        "Horneado artesanal en horno de lena",
        "Pan con tomate del huerto propio",
        "Degustacion de productos locales seleccionados",
      ],
    },
    cultural: {
      ...
      activities: [
        ...
        "Taller cultural personalizado (ceramica, yoga, pintura...)",
        "Comida completa con productos de la tierra",
        "Tiempo de relajacion en la piscina",
        "Experiencia adaptada segun el grupo",
      ],
    },
  },
  ubicacio: {
